			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown">
					...
					<ul aria-labelledby="dropdownMenu1" class="dropdown-menu">
						<li>
							<a href="#" class="dropdown-item">Academic Relief</a>
						</li>
						<li>
							<a href="#" class="dropdown-item">Online Workshops</a>
						</li>
						...
						<li class="dropdown-submenu">
							...
							<ul aria-labelledby="dropdownMenu2" class="dropdown-menu">
								<!-- border-0 shadow -->
								<li>
									<a tabindex="-1" href="#" class="dropdown-item">Checklist</a>
								</li>
								<li>
									<a tabindex="-1" href="#" class="dropdown-item">Time Management</a>
								</li>
								<li>
									<a tabindex="-1" href="#" class="dropdown-item">Environment</a>
								</li>
								<li>
									<a tabindex="-1" href="#" class="dropdown-item">SQ3R - Improving Reading Comprehension</a>
								</li>
								<li>
									<a tabindex="-1" href="#" class="dropdown-item">Concentration</a>
								</li>
								<li>
									<a tabindex="-1" href="#" class="dropdown-item">Motivation</a>
								</li>
								<li>
									<a tabindex="-1" href="#" class="dropdown-item">Note-Taking</a>
								</li>
								<li>
									<a tabindex="-1" href="#" class="dropdown-item">Recall</a>
								</li>
								<li>
									<a tabindex="-1" href="#" class="dropdown-item">Difficult Questions</a>
								</li>
								<li>
									<a tabindex="-1" href="#" class="dropdown-item">Vocabulary</a>
								</li>
								<li>
									<a tabindex="-1" href="#" class="dropdown-item">Writing Papers</a>
								</li>
							</ul>
						</li>
					</ul>
