...
<div class="row">
	<div class="col-md-6">
		<div class="card flex-row flex-wrap" style="margin-bottom: 3px;">
			...
			<div class="card-block px-2" style="padding-top: 10px; margin-left: 5px">
				<h4 class="card-title">Charlotte Amenkhienan</h4>
				<p class="card-text">Assistant Director for Outreach Services
					<br>
					<a href="mailto:camen@vt.edu">camen@vt.edu</a>
					<br>
					<a href="tel:540-231-6557">540-231-6557</a>
				</p>
			</div>
	...
	<div class="col-md-6">
		<div class="card flex-row flex-wrap" style="margin-bottom: 3px;">
			...
			<div class="card-block px-2" style="padding-top: 10px; margin-left: 5px">
				<h4 class="card-title">Gary Bennett</h4>
				<p class="card-text">Assistant Director for Sport Psychology
					<br>
					<a href="mailto:gabennet@vt.edu">gabennet@vt.edu</a>
					<br>
...
<div class="row">
	<div class="col-md-6">
		<div class="card flex-row flex-wrap" style="margin-bottom: 3px;">
			...
			<div class="card-block px-2" style="padding-top: 10px; margin-left: 5px">
				<h4 class="card-title">Cathye Griffin Betzel</h4>
				<p class="card-text">Assistant Director for Training
					<br>
					<a href="mailto:cbetzel@vt.edu">cbetzel@vt.edu</a>
					<br>
					<a href="tel:540-231-6557">540-231-6557</a>
				</p>
			</div>
...
<div class="row">
	<div class="col-md-6">
		<div class="card flex-row flex-wrap" style="margin-bottom: 3px;">
			...
			<div class="card-block px-2" style="padding-top: 10px; margin-left: 5px">
				<h4 class="card-title">Trent Davis</h4>
				<p class="card-text">Coordinator - Animal Assisted Therapy
					<br>
					<a href="mailto:trentdavis@vt.edu">trentdavis@vt.edu</a>
					<br>
					<a href="tel:540-231-2556">540-231-2556</a>
				</p>
			</div>
...
<div class="row">
	...
	<div class="col-md-6">
		<div class="card flex-row flex-wrap" style="margin-bottom: 3px;">
			...
			<div class="card-block px-2" style="padding-top: 10px; margin-left: 5px">
				<h4 class="card-title">Jennifer Slusher</h4>
